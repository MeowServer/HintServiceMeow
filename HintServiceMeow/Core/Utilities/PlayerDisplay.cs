    ...
    public class PlayerDisplay : IPlayerDisplay
    {
            ...
            ICoroutineRunner? coroutineRunner = null)
        {
            ...
            if (displayOutputs != null)
            {
                ...
                foreach (var displayOutput in displayOutputs)
                {
            ...
            : this(new ReferenceHubContext(referenceHub))
        {
            ...
            var displayOutput = new ScpslDisplayOutput(referenceHub);
                ...
                currentParserTask =
                    ConcurrentTaskDispatcher.Instance.Enqueue(async () =>
                    {
                        try
                        {
                            ...
                            {
                                HintParserResult result = hintParser.ParseToMessage(new(hintCollection, xyRatio));
