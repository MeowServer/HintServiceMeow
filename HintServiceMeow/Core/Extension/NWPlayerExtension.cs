namespace HintServiceMeow.Core.Extension
{
    ...
    public static class NWPlayerExtension
    {
        ...
        public static void AddHint(this LabApi.Features.Wrappers.Player player, IEnumerable<AbstractHint>? hints)
        {
            if (hints is null)
                return;
        ...
        /// <param name="player">The LabApi player to show the hint on.</param>
        /// <param name="hints">The hints to add.</param>
        public static void AddHint(this LabApi.Features.Wrappers.Player player, params AbstractHint[]? hints)
        {
        ...
        public static void AddHint(this LabApi.Features.Wrappers.Player player, AbstractHint? hint, string groupName)
        {
            if (hint is null)
                return;
        ...
        public static void ShowHint(this LabApi.Features.Wrappers.Player player, AbstractHint hint, float duration = 7f, AfterShowAction afterShow = AfterShowAction.Remove)
        {
            if (hint is null)
                return;
        ...
        /// <param name="duration">The duration in seconds before the after-show action is applied.</param>
        /// <param name="afterShow">The action to take after the duration elapses.</param>
        public static void ShowHint(this LabApi.Features.Wrappers.Player player, IEnumerable<AbstractHint> hints, float duration = 7f, AfterShowAction afterShow = AfterShowAction.Remove)
        {
            if (hints is null)
                return;
        ...
        public static void RemoveHint(this LabApi.Features.Wrappers.Player player, IEnumerable<AbstractHint>? hints)
        {
            if (hints is null)
                return;
        ...
        /// <param name="player">The LabApi player whose hint is removed.</param>
        /// <param name="hints">The hints to remove.</param>
        public static void RemoveHint(this LabApi.Features.Wrappers.Player player, params AbstractHint[]? hints)
        {
            if (hints is null || hints.Length == 0)
                return;
        ...
        public static void RemoveHint(this LabApi.Features.Wrappers.Player player, AbstractHint? hint, string groupName)
        {
            if (hint is null)
                return;
        ...
        public static void RemoveHint(this LabApi.Features.Wrappers.Player player, string id)
        {
        ...
        public static void RemoveHint(this LabApi.Features.Wrappers.Player player, Guid id) =>
            PlayerDisplay.Get(player).InternalRemoveHint(Assembly.GetCallingAssembly().FullName, id);
        ...
        /// </summary>
        /// <param name="player">The LabApi player whose hint is removed.</param>
        public static void ClearHint(this LabApi.Features.Wrappers.Player player) =>
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="id"/> is <see langword="null"/>.</exception>
        /// <exception cref="ArgumentException">Thrown when <paramref name="id"/> is an empty string.</exception>
        public static AbstractHint? GetHint(this LabApi.Features.Wrappers.Player player, string? id)
        {
            if (string.IsNullOrEmpty(id))
        ...
        /// <returns>The matching <see cref="AbstractHint"/>, or <see langword="null"/> if none is found.</returns>
        public static AbstractHint? GetHint(this LabApi.Features.Wrappers.Player player, Guid guid) =>
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="id"/> is <see langword="null"/>.</exception>
        /// <exception cref="ArgumentException">Thrown when <paramref name="id"/> is an empty string.</exception>
        public static IEnumerable<AbstractHint> GetHints(this LabApi.Features.Wrappers.Player player, string id)
        {
            if (string.IsNullOrEmpty(id))
        ...
        public static IEnumerable<AbstractHint> GetHints(this LabApi.Features.Wrappers.Player player) =>
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="id"/> is <see langword="null"/>.</exception>
        /// <exception cref="ArgumentException">Thrown when <paramref name="id"/> is an empty string.</exception>
        public static bool HasHint(this LabApi.Features.Wrappers.Player player, string id)
        {
            if (string.IsNullOrEmpty(id))
        ...
        /// <param name="guid">The unique identifier to search for.</param>
        /// <returns><see langword="true"/> if a matching hint exists; otherwise <see langword="false"/>.</returns>
        public static bool HasHint(this LabApi.Features.Wrappers.Player player, Guid guid) =>
        ...
        /// <exception cref="ArgumentException">Thrown when <paramref name="id"/> is an empty string.</exception>
#nullable disable
        public static bool TryGetHint(this LabApi.Features.Wrappers.Player player, string id, out AbstractHint hint)
        {
            if (string.IsNullOrEmpty(id))
        ...
        /// <param name="hint">When this method returns, contains the matching hint, or <see langword="null"/> if none was found.</param>
        /// <returns><see langword="true"/> if a matching hint was found; otherwise <see langword="false"/>.</returns>
        public static bool TryGetHint(this LabApi.Features.Wrappers.Player player, Guid guid, out AbstractHint hint)
        {
...
#nullable restore
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="id"/> is <see langword="null"/>.</exception>
        /// <exception cref="ArgumentException">Thrown when <paramref name="id"/> is an empty string.</exception>
        public static bool TryGetHints(this LabApi.Features.Wrappers.Player player, string? id, out IEnumerable<AbstractHint> hints)
        {
            if (string.IsNullOrEmpty(id))
